...
class AuthService {
  ...
  static Future<AuthResponse> register({
    ...
    try {
      ...
      if (authResponse.success &&
        ...
        await _saveUserData(authResponse.token!, authResponse.user!);
      }
  ...
  static Future<AuthResponse> authenticateGoogleAccount(
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(ApiConstants.baseUrl + ApiConstants.googleAuthEndpoint),
        headers: {'Content-Type': 'application/json'},
  ...
  static Future<void> _saveUserData(String token, User user) async {
    try {
